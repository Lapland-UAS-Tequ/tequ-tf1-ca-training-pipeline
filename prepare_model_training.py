...
print("1 - ssd_mobilenet_v1_quantized_300x300_coco14_sync_2018_07_18\n")
print("2 - ssd_mobilenet_v2_quantized_300x300_coco_2019_01_03\n")
print("3 - ssd_mobilenet_v1_coco\n")
print("4 - ssd_mobilenet_v2_coco\n")
print("5 - ssd_resnet_50_fpn_coco\n")
print("\r\n\r\n")
...
if model_selection == 1:
	...
	MODEL_TYPE = 'ssd_mobilenet_v2_quantized_300x300_coco_2019_01_03'
	CONFIG_TYPE = 'ssd_mobilenet_v2_quantized_300x300_coco'
elif model_selection == 3:
	MODEL_TYPE = 'ssd_mobilenet_v1_coco_2018_01_28'
	CONFIG_TYPE = 'ssd_mobilenet_v1_coco'
elif model_selection == 4:
	MODEL_TYPE = 'ssd_mobilenet_v2_coco_2018_03_29'
	CONFIG_TYPE = 'ssd_mobilenet_v2_coco'
elif model_selection == 5:
	MODEL_TYPE = 'ssd_resnet50_v1_fpn_shared_box_predictor_640x640_coco14_sync_2018_07_03'
	CONFIG_TYPE = 'ssd_resnet50_v1_fpn_shared_box_predictor_640x640_coco14_sync'
else:
  ...
  with tf.python_io.TFRecordWriter(output) as writer:
    ...
    for image_name in images:
      try:
        ...
        pass
#Mount Cloud annotations files from object storage
...
pipeline_skeleton = basepath+'\\models\\research\\object_detection\\samples\\configs\\' + CONFIG_TYPE + '.config'
